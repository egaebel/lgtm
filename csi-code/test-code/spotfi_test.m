function spotfi_test
    ...
    path('/home/egaebel/grad-docs/research/thesis/project/linux-80211n-csitool-supplementary/matlab', path);
	path('/home/egaebel/grad-docs/research/thesis/project/linux-80211n-csitool-supplementary/matlab/sample_data', path);
    close all
    clc
    close_figures();
